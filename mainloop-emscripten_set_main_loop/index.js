...
// {{PRE_LIBRARY}}
  ...
  Module["Browser"] = Browser;function _emscripten_set_main_loop_timing(mode, value) {
  ...
  Module["PATH"] = PATH;var SYSCALLS={mappings:{},buffers:[null,[],[]],printChar:function (stream, curr) {
  ...
  Module["SYSCALLS"] = SYSCALLS;function _fd_write(fd, iov, iovcnt, pnum) {
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 3712, 4), 3712);
  ...
  Module["runAndAbortIfError"] = runAndAbortIfError;var Asyncify={State:{Normal:0,Unwinding:1,Rewinding:2},state:0,StackSize:4096,currData:null,handleSleepReturnValue:0,exportCallStack:[],callStackNameToId:{},callStackIdToFunc:{},callStackId:0,afterUnwind:null,asyncFinalizers:[],sleepCallbacks:[],getCallStackId:function (funcName) {
